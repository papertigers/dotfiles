" Vim color file
"
" Modifications by: Mike Zeller <mike@mikezeller.net>
"
" Original Author: Patrick Stockwell <longnow@tutanota.com>
"
...
let g:colors_name = "monokai-papertigers"

" User Options
if !exists("g:monokai_papertigers_italic")
...
let s:black = { "cterm": 00, "gui": "#000000" }
...
let s:indian_red1 = { "cterm": 203, "gui": "#ff5f5f" }
...
call Highlight("Normal", s:white, s:black, s:none)

call Highlight("Cursor", s:charcoal, s:light_blue, s:none)
call Highlight("Special", s:grey, s:none, s:none)
...
"call Highlight("MatchParen", s:white, s:none, s:bold_underline)
call Highlight("MatchParen", s:orange, s:none, s:bold_underline)
call Highlight("Include", s:white, s:none, s:none)
call Highlight("Conditional", s:indian_red1, s:none, s:none)
call Highlight("Define", s:orange, s:none, s:none)
...
call Highlight("Macro", s:light_blue, s:none, s:none)
...
call Highlight("SpecialKey", s:darker_grey, s:none, s:none)
...
"call Highlight("Folded", s:grey, s:charcoal, s:underline)
call Highlight("Folded", s:grey, s:none, s:underline)
...
call Highlight("Todo", s:white, s:none, s:bold)
...
" Rust highlighting
call Highlight("rustKeyword", s:light_blue, s:none, s:none)
call Highlight("rustMacro", s:light_blue, s:none, s:none)
call Highlight("rustMacroVariable", s:orange, s:none, s:none)
call Highlight("rustMacroRepeat", s:white, s:none, s:none)
call Highlight("rustMacroRepeatCount", s:indian_red1, s:none, s:none)
call Highlight("rustReservedKeyword", s:orange, s:none, s:none)
call Highlight("rustType", s:white, s:none, s:none)
call Highlight("rustIdentifier", s:light_green, s:none, s:none)
call Highlight("rustModPathSep", s:white, s:none, s:none)
call Highlight("rustFunction", s:indian_red1, s:none, s:none)
call Highlight("rustFuncName", s:light_green, s:none, s:none)
call Highlight("rustFuncCall", s:light_blue, s:none, s:none)
call Highlight("rustStorage", s:indian_red1, s:none, s:none)
call Highlight("rustArrowCharacter", s:white, s:none, s:none)
call Highlight("rustEnum", s:light_blue, s:none, s:none)
call Highlight("rustEnumVariant", s:light_green, s:none, s:none)
call Highlight("rustConstant", s:purple, s:none, s:none)
call Highlight("rustRepeat", s:indian_red1, s:none, s:none)
